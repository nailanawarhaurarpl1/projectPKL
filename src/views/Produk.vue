<template>
    ...
    <div v-else>
    <div class="grid md:grid-cols-3 gap-8  mt-10 pl-5" style="margin-top: 100px;">
        ...
        <div class="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-gray shadow-md">
            <a href="#">
                <img class="h-50 rounded-t-lg object-cover"
                    src="https://i.pinimg.com/564x/b0/80/6e/b0806e214ad519140afc96cc069df9e5.jpg" style="width: 500px;"
                    alt="product image" />
            </a>
            <span
                class="absolute top-0 left-0 w-28 translate-y-4 -translate-x-6 -rotate-45 text-center text-sm text-white" style="background-color: #1B2A49;">Sale</span>
            <div class="mt-4 px-5 pb-5">
                ...
                <div>
                    <router-link :to="{ name: 'SingleProduk', params: { id: product.id } }"  class="flex items-center rounded-md  px-5 py-2.5  text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-white-300 mt-5" style="background-color: #5588A3;">
