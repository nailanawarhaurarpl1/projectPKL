...
<div class="flex justify-center items-center w-screen h-screen bg-white">
	...
	<div class="container mx-auto my-4 px-4 lg:px-20">
		...
		<div class="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
            ...
            type="number" placeholder="Phone*" />
				...
				<div class="my-2 w-1/2 lg:w-1/4">
					<button class="uppercase text-sm font-bold tracking-wide  text-gray-100 p-3 rounded-lg w-full 
                      focus:outline-none focus:shadow-outline" style="background-color: #183D3D;">
            Send Message
          </button>
				</div>
			</div>
			...
			<div
				class="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto  rounded-2xl" style="background-color: #183D3D;">
				<div class="flex flex-col text-white">
					<h1 class="font-bold uppercase text-4xl my-4">About</h1>
					<p class="text-gray-400">All buying and selling activities or transactions carried out using electronic media (internet). Although telephone and television are included as electronic means, now they refer more to digital technology or the internet.
					</p>
            ...
            <div class="flex flex-col">
              ...
              <p class="text-gray-400">Gedung Galaksi Jl. Angkasa Raya 1999, Bandung Selatan</p>
            </div>
          </div>
          ...
          <div class="flex my-4 w-2/3 lg:w-1/2">
            ...
            <div class="flex flex-col">
              ...
              <p class="text-gray-400">0813-9548-1954</p>
              <p class="text-gray-400">bemira@gmail.com</p>
            </div>
          </div>
