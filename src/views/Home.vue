<template>
    <div class="header  flex items-center" style="margin-top: 110px;">
        <div class="container mx-auto px-4">
            <div class="header-box flex lg:flex-row flex-col items-center gap-10">
                <div class="box lg:w-1/2 lg:order-1 order-2 lg:text-left text-center"><br>
                    ...
                    <h1 class="font-extrabold md:text-4xl sm:text-3xl text-2xl  mb-4">The best collection of <br> furniture
                        is here</h1>
                    <p class="mb-4 text-slate-600 md:text-base sm:text-sm text-xs ">Find various types of quality furniture.
                        Only with this one website you can see and <br> buy high quality furniture. Immediately order the
                        best furniture or your choice before the stock runs out.</p>
                    <label for="default-search"
                        class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
                    <div class="relative">
                        <a href="/produk">
                            <button type="button" style="width: 150px; height: 45px; background-color: #78C1F3;"
                                class="text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Get
                                Started</button>
                        </a>
                    </div>
                ...
                <div class="box lg:w-1/2 lg:order-2 order-1 lg:pt-0 pt-10">
                    <img src="../assets/img/gambar.PNG"
                        class="xl:w-[600px] lg:w-[400px] md:w-[300px] sm:w-[250px] w-[200px] block ml-auto">
                </div>
            </div>
        </div>
    </div><br><br>
