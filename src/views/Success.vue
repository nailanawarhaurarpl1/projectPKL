 <template>
  ...
  <center>
    ...
    <p class="mb-4 text-slate-600 md:text-base sm:text-sm text-xs ">Order Code : 764651-213748<br><i> A copy of your order summary has been sent to {{ getUser.email}} </i></p> 
  ...
  <div class="overflow-y-hidden rounded-lg border" >
    <div class="overflow-x-auto" >
      <table class="w-full">
        <thead>
          <tr class=" text-left text-xs font-semibold uppercase tracking-widest text-black" style="background-color: #AEC3AE;">
            <th class="px-5 py-3"></th>
            <th class="px-5 py-3" colspan="2"><b> Order Summary</b></th>
        ...
        <tbody class="text-gray-500">
          <tr>
            ...
            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <p class="whitespace-no-wrap" style="color: black;"><b>Order <br> Code : </b></p>
            </td>
            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <p class="whitespace-no-wrap">764651-213748</p>
            </td>
            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <p class="whitespace-no-wrap" style="color: black;"><b>Total Order <br> Amount :</b></p>
            </td>
...
<div class="mx-auto max-w-screen-lg px-4 py-8 sm:px-8">
  ...
  <div class="overflow-y-hidden rounded-lg border" >
    <div class="overflow-x-auto">
      <table class="w-full" >
        <thead>
          <tr class="bg-blue-600 text-left text-xs font-semibold uppercase tracking-widest text-white" style="background-color: #AEC3AE;">
            <th class="px-5 py-3" style="color: black;"><b> ID </b></th>
            <th class="px-5 py-3" style="color: black;"><b> Product </b></th>
            <th class="px-5 py-3" style="color: black;"><b> Quantity </b></th>
            <th class="px-5 py-3" style="color: black;"><b> User Place </b></th>
            <th class="px-5 py-3" style="color: black;"><b> Total </b></th>
          </tr>
        </thead>
        <tbody class="text-gray-500" v-for="cart in getKeranjang" key="cart.id" >
          ...
          <tr>
            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <p class="whitespace-no-wrap"  style="color: black;"><b>{{ cart.cart_id }}</b></p>
            </td>
            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <div class="flex items-center">
                <div class="h-10 w-10 flex-shrink-0">
                  <img class="h-full w-full rounded-full" src="https://i.pinimg.com/564x/b0/80/6e/b0806e214ad519140afc96cc069df9e5.jpg" alt="" />
                </div>
                <div class="ml-3">
            ...
            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <p class="whitespace-no-wrap">Rp. {{ cart.regular_price }}</p>
            </td>

            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <span class="rounded-full bg-green-200 px-3 py-1 text-xs font-semibold text-green-900">Rp. {{ cart.regular_price * cart.qty }}</span>
            </td>
          </tr>
        ...
        <tr>
           <td colspan="3" rowspan="3"><center><img src="../assets/img/fto (1).jpg" style="width: 150px; height: 100px; margin-left: -100px;" alt=""></center></td>
           <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
         ...
         <tr class="bg-blue-600 text-left text-xs font-semibold uppercase tracking-widest text-white" style="background-color: #AEC3AE;">
           <th class="px-5 py-3" style="color: black;"><b> Total </b></th>
           <th class="px-5 py-3" style="color: black;"><b> Rp. {{ totalHarga() }} </b></th>
