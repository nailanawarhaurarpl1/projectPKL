                                            ...
                                            <div class="flex justify-between space-x-8 items-start w-full"
                                                ...
                                                <div class="flex justify-between space-x-8 items-start w-full">
                                                    ...
                                                    <div class="flex items-center border-gray-100">
                                                        <span @click="editqty({ cart_id: cart.cart_id, type: 'minus' })"
                                                            class="cursor-pointer rounded-l bg-gray-100 py-1 px-3.5 duration-100 hover:bg-blue-500 hover:text-blue-50">
                                                            - </span>

                                                        <input type="number" :value="cart.qty"
                                                            class=" border bg-white text-center text-xs outline-none"
                                                            style="width: 60px; height: 35px;">
                                                        <span
                                                            class="cursor-pointer rounded-r bg-gray-100 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50"
                                                            @click="editqty({ cart_id: cart.cart_id, type: 'plus' })"> + </span>
                                                    </div>

                                                </div>

                                            </div><button @click="deleteKeranjang(cart.cart_id)" type="button"
                        ...
                        <div class="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-gray-800 space-y-6">
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base dark:text-gray-300 leading-4 text-gray-600">Rp. {{ totalHarga() }}</p>
                                </div>
                                <div class="flex justify-between items-center w-full">
                                    <p class="text-base dark:text-white leading-4 text-gray-800">Shipping</p>
                                    <p class="text-base dark:text-gray-300 leading-4 text-gray-600">Rp. {{ shipping() }}</p>
                                </div>
                            </div>
                            <div class="flex justify-between items-center w-full">
                                <p class="text-base dark:text-white font-semibold leading-4 text-gray-800">Total</p>
                                <p class="text-base dark:text-gray-300 font-semibold leading-4 text-gray-600"> Rp. {{ subtotal()
                                }}</p>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="flex justify-between items-start w-full">
                                <div class="flex justify-center items-center space-x-4">
                                    ...
                                    <div class="flex flex-col justify-start items-center">
                                        <p class="text-lg leading-6 dark:text-white font-semibold text-gray-800">BMR
                                            Delivery<br /><span class="font-normal">Delivery with 24 Hours</span></p>
                                    </div>
                                </div>
                                <p class="text-lg font-semibold leading-6 dark:text-white text-gray-800">7000</p>
                            </div>
                            <div class="flex w-full justify-center items-center md:justify-start md:items-start">
                                <div v-if="token">
                                    <a href="/login">
                                        <button type="button"
                                            class="hover:bg-black dark:bg-white dark:text-gray-800 dark:hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full text-base font-medium leading-4 text-white"
                                            style="width: 600px; background-color: #5588A3;">
...
export default {
    ...
    methods: {
        ...
        subtotal() {
            this.total = this.getKeranjang.reduce((acc, produk) => {
                return acc + parseFloat((produk.regular_price * produk.qty) + ongkir);
            }, 0);
            return this.total.toFixed(2);
        },
        shipping() {
        ...
        this.total = this.getKeranjang.reduce((acc, product) => {
            return acc + parseFloat(product.min_qty * ongkir);
